# Acknowledgement: Copied from OpenEvolve (https://github.com/codelion/openevolve/blob/main/openevolve/prompt/sampler.py) under Apache-2.0 license
...
from .config import AlphaEvolvePromptConfig
...
class PromptSampler:
    ...
    def __init__(self, prompt_config: AlphaEvolvePromptConfig):
        self.config = prompt_config
        self.template_manager = TemplateManager(prompt_config.template_dir)
