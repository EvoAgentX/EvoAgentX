# Acknowledgement: Copied from OpenEvolve (https://github.com/codelion/openevolve/blob/main/openevolve/database.py) under Apache-2.0 license
...
from evoagentx.utils.alphaevolve_utils.code_utils import calculate_edit_distance
from evoagentx.utils.alphaevolve_utils.metrics_utils import safe_numeric_average

from .config import AlphaEvolveDatabaseConfig
...
class AlphaEvolveDatabase:
    ...
    def __init__(self, config: AlphaEvolveDatabaseConfig):
        self.config = config
