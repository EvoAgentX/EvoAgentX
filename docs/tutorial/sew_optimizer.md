...
For a complete working example, please refer to [sew_optimizer.py](https://github.com/EvoAgentX/EvoAgentX/blob/main/examples/optimization/legacy/sew_optimizer.py).
